...
//    }
    ...
    public void addCustomer(String id, String cid, String fname, String lname, String img, String sex, String tel, String address, String workplace, String bankAcc) {
        Customer customer = new Customer(id,cid, fname, lname, img, sex, tel, address, workplace, bankAcc);
        customers.add(customer);
    }
}
