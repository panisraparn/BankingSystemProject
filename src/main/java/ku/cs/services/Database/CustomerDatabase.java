...
//            String query1 = "INSERT INTO customer " + "VALUES ('"+customer.getCtm_Id()+"','"++"','"+customer.getCtm_firstname()+"','"+customer.getCtm_lastname()+"','"+customer.getCtm_img()+"','"+customer.getCtm_sex()+"','"+customer.getCtm_tel()+"' ,'"+addressStr+"','"+workplaceStr+"','"+bankAccNumStr+"')";
